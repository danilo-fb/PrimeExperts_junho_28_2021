...
Conferir se o preço do produto "Blouse" foi listado no site
     Wait Until Element Is Visible   //h5[@itemprop='price'][contains(.,'$27.00')]
      Element Text Should Be         //h5[@itemprop='price'][contains(.,'$27.00')]    ${produto}